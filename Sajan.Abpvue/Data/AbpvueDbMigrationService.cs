...
public class AbpvueDbMigrationService : ITransientDependency
{
    public ILogger<AbpvueDbMigrationService> Logger { get; set; }
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "Sajan.Abpvue");
    }
